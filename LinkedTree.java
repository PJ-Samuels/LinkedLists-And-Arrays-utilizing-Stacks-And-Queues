...
public class LinkedTree {
    ...
    public int depthIter(int key )
    {
        ...
        while (!q.isEmpty()) {
            ...
            if (item.depth > level && key == item.node.key) {
                System.out.println();
                level++;
            }
    ...
    private static int numEvenKeysRec( Node root){
        ...
        numEvenKeysRec(root.left);
        System.out.print(root.data + "HIT   ");
        numEvenKeysRec(root.right);
        return 1;
    }
    public static int numEvenKeys() {

        //int num = numEvenKeysRec(root);
        return 1;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("(2) Testing on tree from Problem 3, depth of 44 node");
        try {
            LinkedTree tree = new LinkedTree();
            int[] keys2 = { 44, 35, 53, 23, 48, 62, 28, 57, 80 };
            tree.insertKeys(keys2);

            int results2 = tree.depthIter(44);
            System.out.println("actual results:");
        ...
        int ans2 = numEvenKeys();
        System.out.println(ans2);
        
        System.out.println(); 


        System.out.println("(3) Testing on tree from Problem 3, depth of 30 node");
        try {
            LinkedTree tree = new LinkedTree();
            int[] keys3 = { 44, 35, 53, 23, 48, 62, 28, 57, 80 };
            tree.insertKeys(keys3);

            int results3 = tree.depthIter(30);
            System.out.println("actual results:");
